...
//               <button
//                 className="custom-btn"
//                 onClick={() => setShowAddTankyProductModal(true)}
//               >
//                 <FaPlusCircle className="text-warning me-2" />
//                 Add Tanky Product
//               </button>
...
function ProductSection({
  ...
  // YAHAN FADING/DISABLE LOGIC KA STATE ADD KIYA HAI
  const [selectionMode, setSelectionMode] = useState(null); // 'regular' ya 'tanky'

  // AGAR SAARE PRODUCTS DELETE HO JAYEIN TOH BUTTONS WAPAS ENABLE HO JAYENGE
  useEffect(() => {
